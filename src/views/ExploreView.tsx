...
const css=`
.explore-social-v3{padding-bottom:calc(150px + env(safe-area-inset-bottom,0px));background:linear-gradient(180deg,#fbf9ff 0%,#f7f2ff 48%,#fff 100%)}
...
.people-add-strip{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(152px,41%);gap:12px;overflow-x:auto;overflow-y:hidden;padding:2px 52px 8px 1px;scroll-snap-type:x mandatory;scroll-padding-inline:1px 52px;overscroll-behavior-inline:contain;scrollbar-width:none;-webkit-overflow-scrolling:touch}.people-add-strip::-webkit-scrollbar{display:none}.people-add-card{scroll-snap-align:start;scroll-snap-stop:always;display:grid;justify-items:center;gap:7px;padding:15px 12px;border:1px solid rgba(116,71,244,.12);border-radius:24px;background:rgba(255,255,255,.96);box-shadow:0 13px 30px rgba(60,42,115,.08);min-width:0}.people-add-avatar{width:82px;height:82px;border-radius:50%;object-fit:cover;background:#eee9fb}.people-add-card strong{font-size:17px;color:#161d44;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.people-add-card small{color:#81879a;max-width:100%;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;display:flex;align-items:center;justify-content:center;gap:4px}.people-add-card button{width:100%;height:36px;border-radius:999px;border:1px solid #7a4cf4;background:#fff;color:#7143ef;font-size:14px;font-weight:850;display:flex;align-items:center;justify-content:center;gap:6px}.people-add-card button.connected{background:#7547f4;color:#fff}
.story-v3-strip{display:grid!important;grid-template-columns:repeat(4,minmax(0,1fr))!important;column-gap:10px!important;align-items:start!important;overflow:visible!important;padding:2px 0 10px!important;min-height:116px!important}.story-v3-chip{appearance:none!important;border:0!important;background:transparent!important;padding:0!important;min-width:0!important;width:100%!important;display:grid!important;grid-template-rows:68px auto auto!important;justify-items:center!important;align-items:start!important;text-align:center!important;color:inherit!important;font:inherit!important}.story-v3-ring{display:grid!important;place-items:center!important;position:relative!important;width:68px!important;height:68px!important;min-width:68px!important;min-height:68px!important;max-width:68px!important;max-height:68px!important;aspect-ratio:1/1!important;margin:0 auto!important;border-radius:50%!important;padding:3px!important;box-sizing:border-box!important;overflow:hidden!important;background:linear-gradient(135deg,#7347f4,#bd6ae8)!important}.story-v3-ring>img,.story-v3-ring>video{position:absolute!important;inset:3px!important;width:calc(100% - 6px)!important;height:calc(100% - 6px)!important;max-width:none!important;max-height:none!important;margin:0!important;border-radius:50%!important;object-fit:cover!important;object-position:center!important;border:3px solid #fff!important;background:#e9e2fb!important;box-sizing:border-box!important}.story-v3-add .story-v3-ring{padding:0!important;background:#fff!important;border:2px dashed #7b4cf4!important;color:#7647f4!important}.story-v3-add .story-v3-ring svg{width:30px;height:30px}.story-v3-chip strong{position:static!important;display:block!important;width:68px!important;max-width:68px!important;margin:8px 0 0!important;padding:0!important;font-size:12px!important;line-height:15px!important;color:#1e2448!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;transform:none!important}.story-v3-chip small{position:static!important;display:block!important;width:68px!important;max-width:68px!important;margin:2px 0 0!important;padding:0!important;color:#9298a8!important;font-size:11px!important;line-height:14px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;transform:none!important}.community-media-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.community-card{position:relative;overflow:hidden;min-height:240px;border-radius:24px;background:#171529;box-shadow:0 15px 32px rgba(44,32,88,.12)}.community-card img,.community-card video{width:100%;height:100%;position:absolute;inset:0;object-fit:cover}.community-card:after{content:"";position:absolute;inset:36% 0 0;background:linear-gradient(transparent,rgba(9,8,19,.84))}.community-copy{position:absolute;z-index:2;left:13px;right:13px;bottom:13px;color:#fff}.community-copy strong{display:block;font-size:17px;line-height:1.08}.community-copy span{display:flex;align-items:center;gap:5px;margin-top:6px;font-size:12px}.community-video-badge{position:absolute;z-index:3;right:11px;top:11px;width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:rgba(255,255,255,.92);color:#7547f4}.explore-v3-error{padding:10px 12px;border-radius:14px;background:#fff0f1;color:#a83b4b;margin-bottom:12px}.explore-v3-empty{margin:0;color:#7b8195;font-weight:700}
@media(max-width:430px){.explore-social-v3{padding-bottom:calc(158px + env(safe-area-inset-bottom,0px))}.explore-v3-head h2{font-size:25px}.people-add-strip{grid-auto-columns:minmax(148px,41%);padding-right:48px;scroll-padding-right:48px}.story-v3-strip{column-gap:7px!important}.story-v3-chip{grid-template-rows:66px auto auto!important}.story-v3-ring{width:66px!important;height:66px!important;min-width:66px!important;min-height:66px!important;max-width:66px!important;max-height:66px!important}.story-v3-chip strong,.story-v3-chip small{width:66px!important;max-width:66px!important}.community-card{min-height:220px}}
@media(max-width:360px){.people-add-strip{grid-auto-columns:146px}.story-v3-strip{column-gap:4px!important}.story-v3-chip{grid-template-rows:60px auto auto!important}.story-v3-ring{width:60px!important;height:60px!important;min-width:60px!important;min-height:60px!important;max-width:60px!important;max-height:60px!important}.story-v3-chip strong,.story-v3-chip small{width:60px!important;max-width:60px!important}.story-v3-chip strong{font-size:11px!important}.story-v3-chip small{font-size:10px!important}}
`;
...
export function ExploreView({onPlan,extraPlans=[],initialFilter='near',initialCategory=null,onChat}:{onPlan:(plan:Plan)=>void;extraPlans?:Plan[];initialFilter?:ExploreFilter;initialCategory?:string|null;onChat:(name:string)=>void}){
  ...
  const visiblePlans=useMemo(()=>filterExplorePlans([...extraPlans,...plans],{
    timeFilter:initialFilter==='near'&&!peopleState.locationAllowed?'all':initialFilter,
    category:initialCategory,
    query:'',
    sortAsc:true,
  }),[extraPlans,initialCategory,initialFilter,peopleState.locationAllowed]);
  ...
  return <div className="page explore-page explore-social-v3"><style>{css}</style>
    ...
    <section className="explore-v3-section"><div className="explore-v3-head"><h2>Planes para ti</h2><span>{visiblePlans.length} disponibles</span></div>{visiblePlans.length?<PlanCards items={visiblePlans} onPlan={onPlan}/>:<p className="explore-v3-empty">No hay planes que coincidan con este filtro.</p>}</section>

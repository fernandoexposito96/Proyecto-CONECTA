...
export function PeopleSwipeView({people,index,filter,locationAllowed,privacy,onFilter,onBack,onAdvance,onDetail}:{people:Person[];index:number;filter:PeopleFilter;locationAllowed:boolean;privacy:PrivacySettings;onFilter:(value:PeopleFilter)=>void;onBack:()=>void;onAdvance:(action:'like'|'dislike'|'skip')=>void;onDetail:(person:Person)=>void}){

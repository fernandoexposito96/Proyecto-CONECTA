...
function HomeView({
  ...
  return <>
    ...
    <section className="hero-card">
      <img src="https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1800&q=90" alt="Amigos compartiendo una experiencia" />
    ...
    <section className="section-block">
      ...
      <div className="category-row">{categories.slice(0, 12).map(({ label, icon: Icon, image }) => <button className="category" key={label} onClick={() => go("Explorar")}><img src={image} alt="" /><span /><b><Icon />{label}</b></button>)}</div>
    </section>

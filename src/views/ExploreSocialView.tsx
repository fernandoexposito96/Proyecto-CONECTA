...
.people-add-strip{display:grid;grid-auto-flow:column;grid-auto-columns:minmax(172px,1fr);gap:12px;overflow-x:auto;padding:2px 42px 7px 1px;scroll-snap-type:x proximity;scroll-padding-right:42px;overscroll-behavior-inline:contain;scrollbar-width:none;-webkit-mask-image:linear-gradient(90deg,#000 0,#000 calc(100% - 28px),transparent 100%);mask-image:linear-gradient(90deg,#000 0,#000 calc(100% - 28px),transparent 100%)}.people-add-strip::-webkit-scrollbar{display:none}.people-add-card{scroll-snap-align:start;display:grid;justify-items:center;gap:8px;padding:16px 12px;border:1px solid rgba(116,71,244,.12);border-radius:24px;background:rgba(255,255,255,.95);box-shadow:0 13px 30px rgba(60,42,115,.08);min-width:0}.people-add-avatar{width:82px;height:82px;border-radius:50%;object-fit:cover;background:#eee9fb}.people-add-card strong{font-size:18px;color:#161d44}.people-add-card small{color:#81879a;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%}.people-add-card button{width:100%;height:36px;border-radius:999px;border:1px solid #7a4cf4;background:#fff;color:#7143ef;font-size:14px;font-weight:850;display:flex;align-items:center;justify-content:center;gap:6px;padding:0 10px}.people-add-card button svg{width:17px;height:17px;stroke-width:2}.people-add-card button.connected{background:#7547f4;color:#fff}.people-add-empty{padding:18px;border-radius:20px;background:#fff;color:#777e91}
.story-v2-strip{display:flex;gap:15px;overflow-x:auto;padding:2px 1px 8px;scrollbar-width:none}.story-v2-strip::-webkit-scrollbar{display:none}.story-v2-chip{flex:0 0 74px;text-align:center}.story-v2-ring{width:68px;height:68px;margin:auto;border-radius:50%;padding:3px;background:linear-gradient(135deg,#7347f4,#bd6ae8);display:grid;place-items:center}.story-v2-ring>img,.story-v2-ring>video{width:100%;height:100%;border-radius:50%;object-fit:cover;border:3px solid #fff;background:#e9e2fb}.story-v2-add .story-v2-ring{background:#fff;border:2px dashed #7b4cf4;color:#7647f4}.story-v2-chip strong{display:block;margin-top:8px;font-size:12px;line-height:1.15;color:#1e2448;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:none}.story-v2-chip small{display:block;color:#9298a8;font-size:11px;margin-top:2px}
...
@media(max-width:430px){.explore-v2-head h2{font-size:25px}.people-add-strip{grid-auto-columns:158px;padding-right:38px;scroll-padding-right:38px}.people-add-card{padding:14px 10px}.people-add-card button{height:34px;font-size:13px}.community-card{min-height:220px}}
`;

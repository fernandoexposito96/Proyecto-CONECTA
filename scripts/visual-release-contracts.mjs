...
check("home-mobile-cards", /@media\s*\(max-width:820px\)/.test(homeCss) && /action-card-grid/.test(homeCss) && /grid-template-columns:repeat\(4/.test(homeCss), "Accesos móviles de Inicio estructurados en cuatro tarjetas");

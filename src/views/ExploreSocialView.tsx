...
@media(max-width:430px){.explore-social-v2{padding-bottom:108px}.explore-v2-hero{padding-top:4px}.explore-v2-head h2{font-size:25px}.people-add-strip{grid-auto-columns:158px;padding-right:38px;scroll-padding-right:38px}.people-add-card{padding:14px 10px}.people-add-card button{height:34px;font-size:13px}.story-v2-strip{column-gap:7px;min-height:112px}.story-v2-item{grid-template-rows:66px auto auto}.story-v2-ring{width:66px!important;height:66px!important;min-width:66px!important;min-height:66px!important;max-width:66px!important;max-height:66px!important}.story-v2-name{font-size:12px!important;line-height:15px!important}.story-v2-meta{font-size:10px!important;line-height:13px!important}.community-card{min-height:220px}}
@media(max-width:360px){.story-v2-strip{column-gap:4px}.story-v2-item{grid-template-rows:60px auto auto}.story-v2-ring{width:60px!important;height:60px!important;min-width:60px!important;min-height:60px!important;max-width:60px!important;max-height:60px!important}.story-v2-name{font-size:11px!important}.story-v2-meta{font-size:9px!important}}
`;
